...
export default function DrinksComponent({data}:CategoryProps)
{
  ...
  return (
    <div className=" w-full flex-col mt-12 ">
      <div className="ml-6 lg:ml-24 flex sm:text-[18px] text-[15px] font-bold text-black " >Drinks</div>
      ...
      <div ref={sliderRef} className="flex overflow-x-auto scroll-smooth w-[90vw] [scrollbar-width:none]" >
        ...
        <button onClick={scrollRight} className="hidden lg:flex w-11 h-11 px-1 mt-12 outline-none border-none bg-transparent ml-5 focus:outline-none focus:ring-0 " ><img src={right} width={100} /></button>
        </div>
    </div>
  )
